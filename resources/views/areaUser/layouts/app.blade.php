            ...
            <div class="container-fluid">
                ...
                <div class="icons">
                    <div class="input-container">
                        <input placeholder="Pesquise algo..." class="input" name="text" type="text">
        ...
        <nav class="navbar navbar-expand-lg custom-navbar">
            <div class="container-fluid">
                ...
                <div class="icons">
                    ...
                    <a href="#"><img src="data:image/png;base64," alt="shopping-cart--v1">   </a>                 
                    <button class="btn_entrar" onclick="window.location.href='{{ url('login') }}'">Entrar</button>
                </div>
