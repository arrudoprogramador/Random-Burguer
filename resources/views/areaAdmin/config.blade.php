        ...
        <h1 class="text-2xl font-bold">🍔 RandomBurguer</h1>
            <nav class="mt-6">
                <ul>
                    ...
                    <a href="{{url('/clientes')}}"><li class="py-2 px-4 hover:bg-gray-700 rounded mt-2 cursor-pointer">Clientes</li></a>
                    <a href="{{url('/registerLanche')}}"><li class="py-2 px-4 bg-gray-400 rounded mt-2 cursor-pointer">Registrar Lanches</li></a>
