...
<body class="bg-gray-100 flex h-screen">
    ...
    <main class="flex-1 p-4 w-[80%]">
        ...
        <h2 class="text-2xl font-semibold">Cadastrar Novo Lanche</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" step="0.01" min="0" name="valorLanche" id="valorLanche" placeholder="Ex: 12.5" required>
                        </div>
                    </div>
                </div>
                <div class="text-center mt-4">
                    <button type="submit" class="btn btn-success px-4 py-2">Cadastrar Produto</button>
                </div>
            </form>
        </div>
        </div>
